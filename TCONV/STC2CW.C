/*
* ============================================================================
* Convert SCT Word Processor to CU-Writer (TIS-620).
...
void usage(void)
{
    fprintf(stderr, "Convert SCT Word Processor to CU-Writer (TIS-620).\n");
    fprintf(stderr, "By Khralkatorrix.\n\n");
    fprintf(stderr, "Usage: stc2cw <input file> <output file>\n");
}
