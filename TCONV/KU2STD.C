/*
* ============================================================================
* Convert Kaset to TIS-620 Thai character code.
...
void usage(void)
{
    fprintf(stderr, "Convert Kaset to TIS-620 Thai character code.\n");
    fprintf(stderr, "By Khralkatorrix.\n\n");
    fprintf(stderr, "Usage: ku2std <input file> <output file>\n");
}
